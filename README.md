...
export TRADING_BOT_TELEGRAM_ANALYSIS_PROGRESS_ENABLED=true
export TRADING_BOT_TELEGRAM_ANALYSIS_PROGRESS_INTERVAL_SECONDS=180
export TRADING_BOT_TELEGRAM_ANALYSIS_PROGRESS_MIN_CYCLE_SECONDS=90
